...
# =====================================================================
# PESTAÑA 3: INGRESO DESPACHO (CON FILTRADO ANTI-DUPLICADOS Y FAST-SAVING)
# =====================================================================
if tab3:
    with tab3:
        ...
        if len(patente_desp) == 6:
            if not st.session_state.df_activas.empty && patente_desp in st.session_state.df_activas["Patente"].values:
...
# =====================================================================
# PESTAÑA 4: SALIDA DESPACHO (CON FUNCIÓN RÁPIDA DE APPEND)
# =====================================================================
if tab4:
    with tab4:
